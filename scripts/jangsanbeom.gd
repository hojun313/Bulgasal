...
@export var speed = 80.0 # Jangsanbeom is faster
@export var health = 150 # Slightly more health
@export var attack_damage = 15
@export var jump_velocity = -350.0
@export var dash_speed = 400.0 # Jangsanbeom dashes faster
...
@onready var roar_timer: Timer = $RoarTimer # New timer for roar
...
var roar_cooldown = 5.0 # Cooldown for roar attack

@onready var jump_sound: AudioStreamPlayer2D = $JumpSound
@onready var dash_sound: AudioStreamPlayer2D = $DashSound
@onready var hurt_sound: AudioStreamPlayer2D = $HurtSound
@onready var roar_sound: AudioStreamPlayer2D = $RoarSound # New sound for roar
...
func _ready():
	...
	roar_timer.wait_time = roar_cooldown
...
func _on_roar_timer_timeout():
	if player:
		roar_sound.play()
		print("Jangsanbeom roars! Player debuffed!")
		# TODO: Apply actual debuff to player (e.g., slow down player speed)
	roar_timer.wait_time = roar_cooldown
	roar_timer.start()
